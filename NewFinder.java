	...
	public static void main(String[] args) {
		...
		Stream<Employee> emps= elist.stream();
		 ...
		 Optional<Employee> person = emps.max(Comparator.comparing(Employee::getHireDate));
			    ...
			    if (person.isPresent()) {
			      System.out.println("Newest Employee: " + person.get().getFirstName()+" "+person.get().getLastName()+" "+person.get().getHireDate());
			    } else {
			      System.out.println("Could not  get   the   Newest employee.");
			    }
